	...
	?>
		<div class="main_content">
			<div class="price-cont">
				...
				<a href="https://unmomento.com.ua/tseny/<?php if ($url_id != 0){ echo '?show='.$url_id; }?>" class="show-more-price">Смотреть весь прайс-лист</a>
			<?php } ?>
				<div class="callback-cont">
					...
					<div class="simple-form-wrap">
						...
						<form method="post" target="rframe" enctype="multipart/form-data" action="/request.php?action=add&amp;id=10">
							<div class="input">
								<input type="text" name="f50" id="phone4" required placeholder="Телефон">
	...
	<div class="form-section">
		...
		if(count($images ) > 2) {
			...
			<div class="banner-cont">
				<img class="banner fits" src="/images/files/<?php echo $image['image']; ?>" alt="<?php echo $image['title']; ?>">
			</div>
		<?php } } ?>
			<div class="form-cont">
				...
				<div class="main-form-wrap">
					<form method="post" target="rframe" enctype="multipart/form-data" action="/request.php?action=add&amp;id=8">
						...
						<div class="input">
							<input type="tel" name="f46"  id="phone5" placeholder="Телефон">
						</div>
