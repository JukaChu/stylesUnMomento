...
<?php include 'mob_header_buttons.php'; ?>
    <div class="top-slider-section">
        <h1 class="title">ЗАБЕРЕМ и ДОСТАВИМ 24\7</h1>
                            ...
                            <div class="aside-formblock ajaxFormWrap">
                                <form id="form_order_delivery" method="post">
                                    ...
                                    <div class="aside-formrow">
                                        <input id="submit_order_delivery" type="submit"  onclick="gtag('event', 'Click', {'event_category': 'Order'});" value="Отправить">
                                    </div>
                                </form>
    ...
    <div class="circles-section">
        <div class="dostavka-title">Как работает сервис</div>
        <div class="c-cont circles-cont">
            <div class="col-25 showPopup" data-show="dostavkaPopup">
                ...
                <div class="c-text-cont">
                    <div class="c-title">Вызвать курьера удобным способом</div>
                    <div class="c-text">через call center, чат-боты, заявку на сайте или скачать приложение</div>
                </div>
            </div>
            <div class="col-25">
                <div class="col-circle">
                ...
                <div class="c-text-cont">
                    <div class="c-title">Мы заберем Ваши вещи в удобное время</div>
                    <div class="c-text">Выбор времени сервиса доставки</div>
                </div>
            </div>
            <div class="col-25">
                <div class="col-circle">
                ...
                <div class="c-text-cont">
                    <div class="c-title">Доставим ваши вещи уже чистыми домой или в офис</div>
                    <div class="c-text">Максимальный комфорт для клиента</div>
                </div>
            </div>
        </div>
    </div>
    <div class="btns-section">
        <div class="c-box-980 clock-bgnd">
            <div class="call-to-action">
                <span class="green"><b>Оформите заказ</b></span> удобным способом: по телефону или на сайте <span class="green"><b>с 9 до 20 часов</b></span>
            </div>
            <div class="um-btns-wrap">
                <div class="col-cont">
                        <div class="col-33">
                                <div class="um-btn btn-blue callAsideForm">Сделать заказ</div>
                        </div>
                        <div class="col-33">
                ...
                <div class="um-form-wrap um-hidden">
                    ...
                    <form method="post" target="_srframe" action="/request.php?action=add&id=10">
                        ...
                        <input class="um-btn btn-purple" type="submit"  onclick="gtag('event', 'Click', {'event_category': 'Order'});" value="Заказать обратный звонок">
                    </form>                                                                                                            
                </div>
            </div>
        </div>
    ...
    <div class="dostavka-price-section">
        <div class="dostavka-title">Цены на услугу</div>
        <div class="price-card-wrap um-price-wrap">
            <div class="c-cont price-card-cont">
                ...
                <div class="col-25 dostavka-price-col">
                    <a href="#" class="col-inner chooseService"  vid-uslug="Unmomento" data-tovar="<?=$item["name"]?>" data-price="<?=$item["price2"]?>" >
                        ...
                        <?php if(round($item["price2"] == 0) ){ ?>
                            <div class="card-price"><span class="font-80">БЕСПЛАТНО</span></div>
                        <?php } else { ?>
        ...
        <div class="um-form-cont c-box-730">
                <div class="um-order-btn-wrap">
                        <div class="umOrderBtn um-green-btn">оформить заказ</div>
                </div>
                    ...
                    */?>
                    <div class="c-box-300">
                        ...
                        <form onsubmit="return false;" >
                                ...
                                <input class="um-green-btn" id="SentOrder" type="submit" onclick="gtag('event', 'Click', {'event_category': 'Order'});" value="Отправить">
                        </form>
                        <div id="message"></div>
                    </div>
                </div>
