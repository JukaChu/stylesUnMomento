<header class="header">
        ...
        <div class="main_content clear_after">
            <div class="top-left-header">
                ...
                <div class="colored-links-wrap">
                    ...
                    <div class="corp-link-wrap">
                        <a href="/uslugi/korporativnoe-obsluzhivanie.html">Корпоративное обслуживание</a>
                    </div>
                </div>
            ...
            <div class="description_header ">
                ...
                <div class="corp-link-wrap mobile-corp-btn">
                    <a href="/uslugi/korporativnoe-obsluzhivanie.html">Корпоративное <br>обслуживание</a>
                </div>
                -->
                <?php } ?>
                <a onclick="gtag('event', 'Click', {'event_category': 'Order'});" class="phone new_padding" href="tel:+380676262495">(067) <span>626-2-495</span> </a>
                <a href="/tseny/" class="calculation" >Расчет стоимости</a>
                <a href="/onlain-zakaz/" class="online-order-btn">Вызвать курьера</a>
                <a href="https://unmomento.com.ua/personal-account/" class="cabinet">Кабинет</a>
    ...
    <div class="container_menu">
        <div class="main_content clear_after ">
            <div style="display:none;" class="tech-works">На сайте ведутся технические работы, корректность цен переуточняйте у оператора.</div>
            <div class="mobi_fons ">
                <a href="/" class="logo">
