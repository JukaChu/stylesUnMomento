<div class="container_sevise inner sideheight">
        <div class="main_content block_margin clear_after sideheight">
            <div class="container_prise">
                <div class="sidebar">
                    ...
                    <?php
                        ...
                        foreach($arr as $r) {
                            ...
                            $img = getResizeImageById($img["id"],"h",array("height"=>200),$img["format"],$img,80); 
                ...
                $img = getResizeImageById($mainImage["id"],"h",array("height"=>200),$mainImage["format"],$mainImage,80); 
