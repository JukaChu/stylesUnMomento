    ...
    <div class="main_content block_margin clear_after">
        <div class="catalog_servise">
            ...
            $services_obj = array(
                0 => array(
                    'title' => 'химчистка',
                    'subtitle' => 'Одежды, обуви, игрушек, штор и тд.',
                    'ids' => array(134, 133, 135, 139, 144, 136, 138, 145, 137, 3408, 3143)
                ),
                1 => array(
                    'title' => 'Ремонт и чистка',
                    'subtitle' => 'Одежды, обуви, сумок и т.д.',
                    'ids' => array(3156, 141, 148, 3164)
                ),
                2 => array(
                    'title' => 'Клининг и домашний мастер',
                    'subtitle' => 'Уборка, чистка мягкой мебели, мойка окон и т.д.',
                    'ids' => array(3178, 147, 143)
                ),
                3 => array(
                    'title' => 'Дополнительные услуги',
                    'subtitle' => '',
                    'ids' => array(1639, 3316, 857)
                )
            );
            ...
            <div class="section-service-block">
                ...
                $img = getImageById($r["imid"]); ?>
                    ...
                    href="<?php echo ($r["id"] == 3016)?'https://unmomento.com.ua/':$r["url"];?>" 
                    class="block_servise"
                ...
                <div class="service-more-btn-wrap">
                    <div class="service-more-btn" onclick="$(this).hide().parents('.section-service-block').find('.service-container-new').height('auto');">Показать ещё</div>
                </div>
            </div>
