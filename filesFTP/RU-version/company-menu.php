...
<div class="top_about clear_after">
        ...
        <div class="container_vfix">
            <div class="block_info">
                ...
                <div class="desc_title">
                    Химчистка UNMOMENTO -<br>
                    всегда выгодно, всегда рядом!
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container_list ">
        ...
        <div class="container_vfix">
            <ul class="block_list">
                <li <?php if($head["id"] == 3264) {?>class='active'<?} ?>><a href="/istorija-kompanii">История компании</a></li>
                <li <?php if($head["id"] == 2813) {?>class='active'<?} ?> ><a href="/klienty/">Наши клиенты и партнеры</a></li>
                ...
                */?>
                <li <?php if($head["id"] == 2987) {?>class='active'<?} ?>><a href="/vakansii/">Вакансии</a></li>
                <?php /*if(!$detect->isMobile()){ ?>
                                <li <?php if($head["id"] == 2988) {?>class='active'<?} ?>><a href="/o-kompanii/3d-tur.html">3D тур</a></li>
                                <?php } */?>
                <li <?php if($head["id"] == 3220) {?>class='active'<?} ?>><a href="/media">Мы в MassMedia</a></li>

                 <li <?php if($head["id"] == 3557) {?>class='active'<?} ?>><a href="/for-feedback">Для обратной связи</a></li>
