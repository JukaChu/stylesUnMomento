            ...
            <div class="service-page__adv">
                ...
                <div class="service-page__adv-list service-page__adv-list--double">
                    <div class="service-page__adv-item showPopup" data-show="dostavkaPopup">
                        ...
                        <p>Вызвать курьера удобным способом</p>
                        <small>через call center, чат-боты, заявку на сайте или скачать приложение</small>
                    </div>
                    <div class="service-page__adv-item">
                        <div class="img">
                            <img src="<?php echo _TEMPL . 'build/img/u-del-2.png' ?>" alt="">
                        </div>
                        <p>Мы заберем Ваши вещи в удобное время</p>
                        <small>Выбор времени сервиса доставки</small>
                    </div>
                    <div class="service-page__adv-item">
                        <div class="img">
                            <img src="<?php echo _TEMPL . 'build/img/u-del-3.png' ?>" alt="">
                        </div>
                        <p>Почистим, погладим, отремонтируем</p>
                        <small>выполняем работы любой сложности</small>
                    </div>
                    <div class="service-page__adv-item">
                        <div class="img">
                            <img src="<?php echo _TEMPL . 'build/img/u-del-4.png' ?>" alt="">
                        </div>
                        <p>Доставим ваши вещи уже чистыми домой или в офис</p>
                        <small>Максимальный комфорт для клиента</small>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="um-padding-container-left">
                                        <div class="um-price-result container_result clear_after">
                                            <div class="form-price__result">
                                                ...
                                                <div class="namber_result">* стоимость указана без учета скидки
                                                </div>
...
<section class="desktop-buttons">
    <div class="container">
        <div class="desk-buttons__list">
            ...
            <a href="" class="desk-btn cl-mdl">Перезвоните</a>
        </div>
