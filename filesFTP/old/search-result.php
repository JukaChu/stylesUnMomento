...
<div class="service-search-results-wrap main_content block_margin">
    <div class = "content_cloud">
        <div class = "wrapper-left clear_after">
            ...
            <div class = "shuba-search"><form id="form" method="get" action="/search-result/"><input id="autocomplete" name="stext" type="text"><i class="fa fa-search"><input type="submit" value=""></i></form></div>
        </div>
    </div>
