...
<?php include 'mob_header_buttons.php'; ?>
    ...
    <div class="main_content block_margin clear_after"> 
        <div class="name_list">
            <h1 class="name_list">Пункти прийому</h1>
            <ul class="city_menu">
        ...
        <div class="name_list">
            <h2 class="quick-find-head">Прокласти маршрут</h2>
            <div class="city_menu quick-find-wrapper">
                ...
                foreach($cities as $city) {
                    ...
                    foreach($allPoints[$city['id']] as $point) {
                        ...
                        echo '<!-- '.var_export($point,true).' -->';
                ?>
                    <option data-city="<?php echo $r["id"] ?>" data-point="<?php echo $point["id"] ?>" data-coord="<?php echo $point["coord"] ?>">м. <?php echo $city["name"]; ?>, <?php echo $point["name"]; ?></option>
                <?php 
                    }
                } 
                ?>
                </select>
                <button id="quick-find-btn" class="quick_map">Як проїхати</button>
            </div>
        </div>
        <button id="btn-store-map" onclick="$('#store_map').toggle();">Показати всі пункти &#10097;</button>
        <?php 
        ...
        <script crossite src="https://developers.google.com/maps/documentation/javascript/examples/markerclusterer/markerclusterer.js"></script>
        ...
        <script crossite src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCd27qbJGmlg629U5Nz1GmlLotFRAFIeY8&callback=initMap"></script>
        ...
        <div class="container_table_punkt">
            <div class="top_table_name clear_after">
                <div class="col_punct">Пункт прийому:</div>
                <div class="col_tel">Телефон:</div>
                <div class="col_job">Режим роботи:</div>
            </div>
                ...
                <ul>
                    ...
                    <li class="clear_after sellingPointBlock">
                        ...
                        <div class="col_addres col_job">
                            ...
                            <?php if($item["coord"] != "") { ?>
                            <a href="#" data-coord="<?= $item["coord"] ?>" class="linck_map">Показати на карті</a>
                            <?php } ?>
                        </div>
                    </li>
                    <?php } ?>
